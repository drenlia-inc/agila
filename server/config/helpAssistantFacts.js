...
- Users and viewers only see boards they are added to as participants. Admins see all boards. Assign boards when inviting (header Invite or Settings → Users). You can also double-click a board tab → Add/remove members, or use the picker on an empty board. Empty membership hides the board from non-admins.
