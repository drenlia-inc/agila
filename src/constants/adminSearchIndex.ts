...
export const ADMIN_SEARCH_INDEX: AdminSearchEntry[] = [
  ...
  },
  {
    ...
    labelKey: 'sso.githubClientId',
    aliases: ['oauth', 'github', 'client id'],
  },
  {
    ...
    labelKey: 'sso.githubClientSecret',
    aliases: ['oauth', 'github', 'secret'],
  },
  {
    id: 'github-callback',
    kind: 'setting',
    tab: 'system-settings',
    hash: '#admin#system-settings#sso',
    settingKey: 'GITHUB_CALLBACK_URL',
    labelKey: 'sso.githubCallbackUrl',
    aliases: ['callback', 'redirect', 'oauth', 'github'],
  },
  {
    id: 'm365-client-id',
    kind: 'setting',
    tab: 'system-settings',
    hash: '#admin#system-settings#sso',
    settingKey: 'M365_CLIENT_ID',
    labelKey: 'sso.m365ClientId',
    aliases: ['oauth', 'microsoft', 'entra', 'client id'],
  },
  {
    ...
    tab: 'system-settings',
    hash: '#admin#system-settings#sso',
    settingKey: 'M365_CLIENT_SECRET',
    labelKey: 'sso.m365ClientSecret',
    aliases: ['oauth', 'microsoft', 'secret'],
  },
  {
    id: 'm365-tenant-id',
    kind: 'setting',
    tab: 'system-settings',
    hash: '#admin#system-settings#sso',
    settingKey: 'M365_TENANT_ID',
    labelKey: 'sso.m365TenantId',
    aliases: ['oauth', 'microsoft', 'tenant', 'directory'],
  },
  {
    id: 'm365-callback',
    kind: 'setting',
    tab: 'system-settings',
    hash: '#admin#system-settings#sso',
    settingKey: 'M365_CALLBACK_URL',
    labelKey: 'sso.m365CallbackUrl',
    aliases: ['callback', 'redirect', 'oauth', 'microsoft'],
  },
